...
[Сегментация клиентов банка по используемым продуктам](https://github.com/AnastasiaPershikova/Banks_customer_segmentation) | Выявление сегментов пользователей по потреблению для повышения качества обслуживания и снижения оттока клиентов |  Обзор данных
    Предобработка
    Исследовательский анализ данных
    Проверка статистических гипотез
    Сегментация пользователей по потреблению
    Выводы и рекомендации | `Python`, `Pandas`, `NumPy`, `Matplotlib`, `Seaborn`, `Tableau`|
